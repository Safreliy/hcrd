...
The implementation, tests, experiment protocols, compact outputs, source and
feature hashes, and environment instructions are available at
\url{https://github.com/Safreliy/hcrd}. Large third-party-derived feature
caches are rebuilt locally and are not redistributed. Code is licensed under
MIT; the manuscript, documentation, original figures, protocols, and original
